...
write_tsv(data_ht_lod, file = "../../data/final_data/data_phase2_batch5_raw_20250701.tsv")
```
...
plot_cohort_n(plot_data = qc$manifest_filtered,
              save_plot = "da_phase2_batch5_cohorts")
```
...
plot_plate_distribution(plot_data = qc$mapped_data,
                        save_plot = "da_phase2_batch5_plates")
```
...
plot_qc_warnings(plot_data = data_step_1,
                 ...
                 save_plot = "samples_qc_batch5_cohort")

plot_qc_warnings(plot_data = data_step_1,
                 plot_type = "barplot_type",
                 save_plot = "samples_qc_batch5_warning")
```
...
plot_qc_warnings(plot_data = data_step_1,
                 plot_type = "beeswarm",
                 save_plot = "samples_qc_batch5_beeswarm")
```
...
plot_sample_detectability(plot_data = sample_detected_proteins,
                          save_plot = "detectability_batch5")
```
...
plot_dim_reduction(plot_data = pca_high_detectability$pca_res,
                   ...
                   method = "pca",
                   save_plot = "p2_b5_pca_high_detectability_disease") 
```
...
plot_dim_reduction(plot_data = umap_high_detectability,
                   ...
                   method = "umap",
                   save_plot = "p2_b5_umap_high_detectability_disease") 
```
...
write_tsv(curated_data, file = "../../data/final_data/data_phase2_batch5_curated_20250701.tsv") 
```
