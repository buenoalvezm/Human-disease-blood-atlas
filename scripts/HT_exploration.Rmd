...
# Read data
data_ht <- read_parquet("data/cs-transfer/VL-3530B1_complete_NPX_2024-07-01.parquet")
manifest <- read_excel("data/samples_2024-04-19.xlsx")
concentration_info <- read_xlsx("data/concentrations_blood-atlas-build.xlsx")
data_phase1 <-  read_csv("data/final_data/data_NPX_cohort.csv")
data_NPX_phase1 <- read_csv(file = "data/final_data/final_data_phase1.csv") 
