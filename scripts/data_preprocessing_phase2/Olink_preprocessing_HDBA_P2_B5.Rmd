...
write_tsv(data_ht_lod, file = "../data/final_data/data_phase2_batch5_raw_20250512.tsv")
```
...
ggsave(savepath("pca_batch5.png"), h = 8, w = 8)
...
write_tsv(curated_data, file = "../data/final_data/data_phase2_batch5_curated_20250512.tsv") 
```
