...
## Save wellness data for Mai

```{r}

manifest |> 
   filter(Cohort == "WELL") |> View()

# Filter to Wellness samples
data_step_1 |> 
  left_join(manifest |> 
  ...
  write_csv("data/final_data/data_phase2_wellness.csv")
  #write_parquet("data/final_data/data_phase2_wellness.parquet")  
...
write_csv(data_step_5, file = "data/final_data/data_phase2_20241110.csv")  
```
